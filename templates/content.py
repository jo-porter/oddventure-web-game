...
wake_room_intro = """
		You wake up from a deep sleep, finding yourself in a room. You call
		out, but there is no answer. The only door is locked. You survey
		the room: There is a tunnel on the south side, and a ventilation
		shaft to the north. Which do you choose?
	"""
...
message = """
	   --------------------------------------------------------------------
	  | Life is a game of chance, the throw of a dice from another's hand. |
	  | To believe yourself master of your own universe is madness itself. |
	  | Yet still we persist, and so shall you....Spin the wheel my child. |
	   ---------------------------------------------------------------------
	"""
...
"""
pixie_intro = """
		You travel through the shaft which ends high above a walled garden. You 
		drop from the opening, carefully cushioning your landing on a bush below. 
		You see a single door, bolted and padlocked. A pixy sits cross legged in 
		the centre of the garden, meditating...or sleeping, you can't really 
		tell. Do you tap her on the shoulder or whisper in her ear?
"""

pixie_intro_mini = """
		Tap her on the shoulder or whisper in her ear?
"""
